...
<h1 class="text-2xl font-bold mb-6">Vous modifiez la category {{$category->name }}</h1>
@if($errors->all())
<div
        ...
        <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
          <div class="grid grid-cols-3 gap-6">
            <div class="col-span-3 sm:col-span-2">
              <label name="title" for="company-website" class="block text-sm font-medium text-gray-700">Nom de la catégorie</label>
