...
<head>
    ...
    <title>Invce - Invoice HTML Template - Roofing Services</title>
...
<body>
    <div class="invoice-container-wrap">
        <div class="invoice-container">
            <main>
                <div class="as-invoice invoice_style19">
                    <div class="download-inner" id="download_section">
                        <header class="as-header header-layout12">
                            <div class="row align-items-center justify-content-between">
                                ...
                                <div class="col-auto">
                                    <h1 class="big-title">Invoice</h1><span><b>Invoice No: </b>#935648</span>
                                </div>
                            </div>
                        </header>
                        <hr class="style1">
                        <div class="row justify-content-between my-4">
                            <div class="col-auto">
                                <div class="invoice-left"><b>Bill To:</b>
                                    <address>Alex Jender<br>4510 E 96th St, Indianapolis,<br>Pabna, Rajshahi<br>+153
                                        6523 8453</address>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="invoice-midle"><b>Date of
                                        Issued:</b><br><span>27/07/2022</span><br><br><b>Due
                                        Date:</b><br><span>28/07/2022</span></div>
                            </div>
                            <div class="col-auto">
                                <div class="invoice-right"><b>Invce Roofing:</b>
                                    <address>4510 E 96th St, Indianapolis,<br>Pabna,
                                        Rajshahi<br>info@invcehouse.com<br>+153 3256 3548</address>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-between">
                            <div class="col-auto"><b>Terms & Conditions</b>
                                <p class="mb-4">Authoritatively envisioneer business<br>action items through parallel
                                    sources.</p>
                                <div class="pt-4">
                                    <p class="singature mt-5">Signature of Clients</p>
                                </div>
                            </div>
                            <div class="col-auto">
                        ...
                        <p class="company-address style2"><b>Invce Inc:</b><br>12th Floor, Plot No.5, IFIC Bank, Gausin
                    ...
                    <div class="invoice-buttons"><button class="print_btn"><svg width="16" height="16"
                                ...
                                <path
                                    ...
                                    fill="white" />
                            </svg> <span>Print</span></button> <button id="download_btn" class="download_btn"><svg
