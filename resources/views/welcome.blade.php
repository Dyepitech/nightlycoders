        ...
        <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
          <div class="mt-10 lg:mt-0">
            ...
            <a
              ...
              class="inline-flex items-center justify-center rounded-lg bg-gray-800 py-4 px-10 text-center text-base font-normal text-white hover:bg-opacity-90 lg:px-8 xl:px-10"
            >
              Get Started
            </a>
          </div>
...
x-data="
  {
    ...
    inactiveClasses: 'text-body-color hover:bg-gray-800 hover:text-white',
  }
"
